...
echo "<h2 align='center'> Inserisci UTENTE</h2>
...
?>
 ...
 <form action="IN_USER.php" method="post" id="registra" name="registra" ng-controller="ValidaRegistra" novalidate>
      <label for="txt7"> Tipo: </label> <br>
      ...
      <input type="text" name="cogn" id="cogn" ng-model="cogn" required>
       ...
       <input type="date" name="birth" id="birth" ng-model="birth" required>
        ...
        <input type="submit" id="submit" value="Inserisci" name="submit">
